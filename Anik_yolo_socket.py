...
lib = CDLL("/home/jetson-2/darknet/libdarknet.so", RTLD_GLOBAL)
...
def recImage(client,data,q):
    ...
    while True:
        ...
        endtime = time.time()
        throughput = (size*8/(endtime-starttime))/10**6
        print("throughput: %s Mbps" % throughput)

	#f1 = open('/home/jetson-2/Desktop/throughput.txt','a')
	#print >> f1, "%f" %throughput
	#f1.close()
        ...
        #f2 = open('/home/jetson-2/Desktop/haoxin/images/newNexus320/320off/datasize320.txt','a')
        #print >> f2, "%f" %size
        #f2.close()

        #if frameid>= 45 and frameid<=50:
        #    cv2.imwrite("/home/jetson-2/Desktop/haoxin/images/newNexus320/320off/image%2d.bmp" %frameid,decimg)
...
def showPicResult(r,im,frameID):
    ...
    #if frameID>= 45 and frameID<=50:
    #    cv2.imwrite("/home/jetson-2/Desktop/haoxin/images/newNexus320/320off/image%3d.bmp" %frameID,im)
    cv2.imshow('Detection Window at Server', im)

if __name__ == "__main__":
    detect_net = load_net (b"/home/jetson-2/darknet/cfg/yolov3.cfg", b"/home/jetson-2/darknet/yolov3.weights", 0)
    print('Weight done')
    detect_meta = load_meta(b"/home/jetson-2/darknet/cfg/coco.data")
    print('coco data done')
    ...
    while True:
        if not q.empty():
            ...
            f1 = open('/home/jetson-2/Desktop/Inference.csv','a') #appending to the file
            #items = [str(now), " :: ", "Frame_no: ", str(frameID), " :: ", str(CompuLatency), " sec" "\n"]
            items = [str(CompuLatency), "\n"]
            f1.writelines(items)
